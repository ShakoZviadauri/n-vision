...
class WidgetForMenuNewsFeed extends StatefulWidget {
  const WidgetForMenuNewsFeed({super.key});

  @override
  _WidgetForMenuNewsFeedState createState() => _WidgetForMenuNewsFeedState();
}


class _WidgetForMenuNewsFeedState extends State<WidgetForMenuNewsFeed> {
